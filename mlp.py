...
Um pipeline robusto e eficiente de Machine Learning em PyTorch seguindo as 8 fases críticas de design:
1. Reprodutibilidade
...
7. Diagnóstico com Métricas Adicionais
...
print("\n" + "="*70)
print("FASE 1: REPRODUTIBILIDADE E PREPARAÇÃO DO AMBIENTE")
print("="*70)

SEED = 42

# Seed para PyTorch (CPU e GPU)
...
print(f"\n[OK] Seeds configurados com valor: {SEED}")
print(f"[OK] Dispositivo disponível: {'CUDA (GPU)' if torch.cuda.is_available() else 'CPU'}")
...
print("\n" + "="*70)
print("FASE 2: ENGENHARIA DE DADOS (DATA PIPELINE)")
print("="*70)
...
print(f"\n[OK] Dataset carregado e analisado com sucesso!")
...
print("\n[2.3] Normalização dos Dados (StandardScaler)")
...
print(f"\n[OK] Dados normalizados com sucesso (sem data leakage!)")


# ===== FASE 3: DESIGN E CONSTRUÇÃO DA ARQUITETURA MLP =====
print("\n" + "="*70)
print("FASE 3: DESIGN E CONSTRUÇÃO DA ARQUITETURA MLP")
print("="*70)
...
hidden_size = 64  # 1 camada oculta com 64 neurônios
...
print("\n" + "="*70)
print("FASE 4: CONFIGURAÇÃO DO TREINAMENTO")
print("="*70)
...
# ===== FASE 5: LOOP DE TREINAMENTO =====
print("\n" + "="*70)
print("FASE 5: LOOP DE TREINAMENTO E MONITORAMENTO")
print("="*70)
...
print("\n" + "="*70)
print("FASE 6: AVALIAÇÃO NO CONJUNTO DE TESTE")
print("="*70)
...
# ===== FASE 7: DIAGNÓSTICO COM MATRIZ DE CONFUSÃO E MÉTRICAS =====
print("\n" + "="*70)
print("FASE 7: DIAGNÓSTICO COM MATRIZ DE CONFUSÃO E MÉTRICAS")
print("="*70)
...
print("\n" + "="*70)
print("FASE 8: PERSISTÊNCIA DO MODELO")
print("="*70)
...
print("\n" + "="*70)
print("BONUS: INFERÊNCIA EM NOVAS AMOSTRAS")
print("="*70)
...
# Exemplo 1: Amostra do conjunto de teste
sample_index = 0
...
# ===== FUNÇÃO DE RELATÓRIO DO MODELO =====
def gerar_relatorio_modelo(model, hidden_size, learning_rate, test_accuracy, train_acc, val_acc):
    """
    Gera um relatório profissional do modelo com métricas e diagnóstico
    ...
    Args:
        ...
        train_acc: Acurácia no conjunto de treino (útil para diagnóstico)
    ...
    if hidden_size >= 64:
        observation = "Ao aumentar o número de neurônios para 64 ocorreu overfitting."
    elif gap > 0.15:
        observation = "[WARNING] OVERFITTING: Modelo decorou os dados de treino (gap > 0.15)"
    elif gap < -0.05:
        observation = "[WARNING] UNDERFITTING: Modelo não aprendeu bem o padrão"
    else:
        observation = "[OK] Modelo bem ajustado e generalizado"
    
    # ===== GERAR RELATÓRIO FORMATADO =====
    print("\n" + "="*60)
    print(f"Modelo testado: {model_name}")
    print(f"Ativação: {activation}")
    print(f"Otimizador: {optimizer_name}")
    print(f"Learning rate: {learning_rate}")
    
    print("\nResultado:")
    print(f"Accuracy: {test_accuracy*100:.0f}%")
...
relatorio = gerar_relatorio_modelo(
    model=model,
    hidden_size=hidden_size,
    learning_rate=learning_rate,
    test_accuracy=test_accuracy,
